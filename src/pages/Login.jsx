...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.email.includes('user') && formData.password.length >= 6) {
      ...
      setError('Invalid credentials. Try with an email containing "user" and password with at least 6 characters');
    }
  };
    ...
    <div className="flex justify-center items-center min-h-[80vh]">
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="card-title text-2xl font-bold text-center mb-6">Login to Postify</h2>
